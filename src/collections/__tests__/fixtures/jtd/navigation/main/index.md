...
For the construction of the navigation display to work (and to avoid potential confusion when browsing) _**the page titles on your site need to satisfy the following requirements:**_
